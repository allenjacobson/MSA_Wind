...
dt_revenue_matched<- readRDS(paste0(dir_output, "/dt_revenue.rds"))
...
for (this_trip in unique_trips) {
  ...
  dt_paths_vtrb_revenue <- rbindlist(list(dt_paths_vtrb_cumulative_imgid, these_paths))
}
